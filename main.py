...
Returns:
tuple: A tuple containing all results (original result, failed result, final result, adjusted result, adjusted failed result, adjusted final result)
"""
        ...
        for num_tasks in num_chains:
            ...
            for per_jitter in jitters:
                ...
                if final_e2e_max_active != 0:
                    ...
                    if r_active > 1 + TOLERANCE:  # if rate is larger than 1, then algorithm failed
...
"""Comparison of RTSS2025(passive, active) and Gunzel IC
Compare implicit communication  'Gunzel' vs 'our passive analysis' vs 'our active analysis'.
    Gunzel: [C] Günzel, Mario, et al. "Compositional timing analysis of asynchronized distributed cause-effect chains." ACM Transactions on Embedded Computing Systems 22.4 (2023): 1-34.
"""
...
"""Comparison of RTSS2025(passive, active) and Gunzel LET"""
...
"""Comparison plots(line,hist) of passive and active"""
...
"""Implicit communication comparison experiment (passive/active/IC)"""
...
"""LET communication comparison experiment (passive/active/LET)"""
