...
def filter_and_export_csv_C1(csv_file_path, num_chains):
    """
    Read the CSV file generated by output_results and create filtered CSV files.
    
    Args:
        csv_file_path (str): Path to the original CSV file
        num_chains (list): List of number of tasks to filter
    
    Returns:
        tuple: Lists of file paths for all data and 20% jitter data
    """
    ...
    for num_tasks in num_chains:
        ...
        # Define file paths
        all_data_file = os.path.join(data_dir, f"data{num_tasks}.csv")
        jitter_20_file = os.path.join(data_dir, f"data{num_tasks}_20per.csv")
