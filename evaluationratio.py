...
def main():
    ...
    percent_plot_name = f"ratio/percent_{num_repeats}_{random_seed}_{timestamp}.png"
    R_plot_name = f"ratio/R_{num_repeats}_{random_seed}_{timestamp}.png"
    results_csv = f"ratio/data_{num_repeats}_{random_seed}_{timestamp}.csv" 
    log_txt = f"ratio/log_{num_repeats}_{random_seed}_{timestamp}.txt"
